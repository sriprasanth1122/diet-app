  ...
  return (
    <Layout title={"Meal-Plans"}>
      <main className=" container">
        ...
        <div className="row">
          <div className="container border-2 border-top border-bottom mb-4 mt-4 rounded-5" style={{ backgroundColor: "#D1F2EB" }}>
        ...
        {/* Filter by category */}
        <div className="row ">
          <div className="col-md-3 rounded-5 h-100 pb-3" style={{ backgroundColor: "#D1F2EB" }}>
          ...
          <div className="col-md-9" id="plan">
            {isLoading ? (
              ...
              <div>
                <h3 className=" text-uppercase text-center p-3 rounded-4" style={{ letterSpacing: "0.2em", backgroundColor: "#D1F2EB" }}>All Diet Plans</h3>
                <div className="row">
                  {plan?.map((p) => (
                    <div
                      key={p._id}
                      navigate={`/plan/${p.slug}`}
                      className="col-sm-1 card ms-3 mb-2 mt-2 p-2 rounded-4 text-center"
