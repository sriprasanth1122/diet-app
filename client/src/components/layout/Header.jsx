...
function Header() {
  ...
  return (
    <>
      ...
      <nav className="container-fluid navbar navbar-expand-md shadow sticky-top bg-nav " style={{ backgroundColor: "#D6EAF8" }}>
        <div className="container text-uppercase fs-6 lh-lg">
          {/* Logo */}
          <Link className="navbar-brand logo-font">Diet App</Link>
          <button
